...
with(df, plot(df$Time, df$Sub_metering_1, type='l', xlab='', ylab='Energy sub metering'))
with(df, lines(df$Time, df$Sub_metering_2, col='red'))
with(df, lines(df$Time, df$Sub_metering_3, col='blue'))
legend("topright", 
